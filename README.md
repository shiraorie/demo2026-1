...
<p align="center">
  <img src="files\var1\мдфт 11.png" width="600" />
</p>

<p align="center">
  <img src="files\var1\мдфт 211.png" width="600" />
</p>

<p align="center">
  <img src="files\var1\111.png" width="600" />
</p>

<p align="center">
  <img src="files\var1\211.png" width="600" />
</p>

**ISP преднастроена, но включать ее надо**

<p align="center">
  <img src="files\var1\ефиду фввкуыы.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\int hq-rtr.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\int br-rtr.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\sshuser.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\ssh.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\dns.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\samba-tool.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\lsblk.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\mdadm create.png" width="600" />
</p>

Проверяем:

<p align="center">
  <img src="files\var1\lsblk raid.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\mdadm detail.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\mkfs.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\mkdie raid.png" width="600" />
</p>

<p align="center">
  <img src="files\var1\fstab.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\mount raid.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\df -h raid.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\export.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\exportfs.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\fstab cli.png" width="600" />
</p>
...
- На ISP настройте сервер chrony, выберите стратум 6
...
<p align="center">
  <img src="files\var1\chrony.png" width="600" />
</p>
...
> - local stratum 6 - устанавливаем для себя значение по stratum = 6;  
...
<p align="center">
  <img src="files\var1\chrony cli.png" width="600" />
</p>

> где: 172.16.10.1 - IPv4 адрес ISP;
...
***curl -o /etc/ansible/hosts https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/var1/hosts.file***

files\var1\hosts.file
...
<p align="center">
  <img src="files\var1\ssh-copy id.png" width="600" />
</p>
...
- Пробросьте порт 2011 на маршрутизаторе HQ-RTR в порт 2011 сервера HQ-SRV, для подключения к серверу по протоколу ssh из внешних сетей
- Пробросьте порт 2011 на маршрутизаторе BR-RTR в порт 2026 сервера BR-SRV, для подключения к серверу по протоколу ssh из внешних сетей.

<p align="center"><b>*BR-RTR*</b></p>

<p align="center">
  <img src="files\var1\nftables br-rtr port.png" width="600" />
</p>

<p align="center"><b>*HQ-RTR*</b></p>

<p align="center">
  <img src="files\var1\nftables hq-rtr 1.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\hosts.png" width="600" />
</p>
...
>scp -P 2011 root@172.16.10.2:/etc/pki/CA/certs/web.au-team.irpo.crt /etc/nginx/ssl/

>scp -P 2011 root@172.16.10.2:/etc/pki/CA/private/web.au-team.irpo.key /etc/nginx/ssl/

>scp -P 2011 root@172.16.10.2:/etc/pki/CA/certs/docker.au-team.irpo.crt /etc/nginx/ssl/

>scp -P 2011 root@172.16.10.2:/etc/pki/CA/private/docker.au-team.irpo.key /etc/nginx/ssl/

<p align="center">
  <img src="files\var1\scp.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\ipsec hq-rtr.png" width="600" />
</p>

Далее нужно настроить файл ipsec.secrets. Вносим туда строку:

***172.16.10.2 172.16.20.2 : PSK “123qweR%”***

<p align="center">
  <img src="files\var1\ipsec secret hq.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\ipsec br-rtr.png" width="600" />
</p>

Далее нужно настроить файл ipsec.secrets. Вносим туда строку:

***172.16.20.2 172.16.10.2 : PSK “123qweR%”***

<p align="center">
  <img src="files\var1\ipsec secret br.png" width="600" />
</p>
...
***curl -o /etc/nftables.conf https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/var1/nftables_hq-rtr.conf***
...
***curl -o /etc/nftables.conf https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/var1/nftables_br-rtr.conf***
