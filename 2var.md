...
isp - ssh root@172.16.30.1
hq-srv - ssh sshuser@192.168.100.2 -p 2012
br-srv - ssh sshuser@192.168.200.2 -p 2012
...
<p align="center">
  <img src="files\var2\vlan hq-srv.png" width="600" />
</p>

<p align="center">
  <img src="files\var2\vlan hq-cli.png" width="600" />
</p>

<p align="center">
  <img src="files\var2\vlan hq-srv 1.png" width="600" />
</p>

<p align="center">
  <img src="files\var2\vlan hq-cli 1.png" width="600" />
</p>

**ISP преднастроена, но включать ее надо**

<p align="center">
  <img src="files\var2\table adress.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\int hq-rtr.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\int br-rtr.png" width="600" />
</p>
...
- Идентификатор пользователя 2012
- Пользователь sshuser должен иметь возможность запускать sudo без дополнительной аутентификации

<p align="center"><b>*HQ-SRV и BR-SRV*</b></p>

<p align="center">
  <img src="files\var2\sshuser.png" width="600" />
</p>
...
- Для подключения используйте порт 2012 
...
<p align="center">
  <img src="files\var2\ssh.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\dns.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\samba-tool.png" width="600" />
</p>
...
- Имя устройства – md2, при необходимости конфигурация массива размещается в файле /etc/mdadm.conf
- Создайте раздел, отформатируйте раздел, в качестве файловой системы используйте ext4
- Обеспечьте автоматическое монтирование в папку /raid1
...
<p align="center">
  <img src="files\var2\lsblk.png" width="600" />
</p>

Создайте RAID 1 массив из двух 1Гб дисков (предположим, они определены как /dev/sdb, /dev/sdc:
...
/dev/sd{b,c} — сборка выполняется из дисков sdb, sdc 

> mdadm --create --verbose /dev/md2 -l 1 -n 2 /dev/sdb /dev/sdc

Результат:

<p align="center">
  <img src="files\var2\mdadm create.png" width="600" />
</p>

Проверяем:

<p align="center">
  <img src="files\var2\lsblk raid.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\mdadm detail.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\mkfs.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\mkdir raid5.png" width="600" />
</p>

<p align="center">
  <img src="files\var2\fstab.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\mount raid.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\df -h raid.png" width="600" />
</p>

### <p align="center"><b>3. Настройте сервер сетевой файловой системы (nfs) на HQ-SRV</b></p>

- В качестве папки общего доступа выберите /raid1/nfs, доступ для чтения и записи исключительно для сети в сторону HQ-CLI
...
Создаём директорию для общего доступа /raid1/nfs, куда ранее был смонтирован RAID - массив:
...
<p align="center">
  <img src="files\var2\exportfs.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\fstab cli.png" width="600" />
</p>
...
- На ISP настройте сервер chrony, выберите стратум 7
...
<p align="center">
  <img src="files\var2\chrony.png" width="600" />
</p>
...
> - local stratum 7 - устанавливаем для себя значение по stratum = 7;  
...
<p align="center">
  <img src="files\var2\chrony cli.png" width="600" />
</p>

> где: 172.16.30.1 - IPv4 адрес ISP;
...
***curl -o /etc/ansible/hosts https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/var2/hosts.file***
...
<p align="center">
  <img src="files\var2\ssh copy id.png" width="600" />
</p>
...
- Пробросьте порт 2012 на маршрутизаторе HQ-RTR в порт 2012 сервера HQ-SRV, для подключения к серверу по протоколу ssh из внешних сетей
- Пробросьте порт 2012 на маршрутизаторе BR-RTR в порт 2012 сервера BR-SRV, для подключения к серверу по протоколу ssh из внешних сетей.

<p align="center"><b>*BR-RTR*</b></p>

<p align="center">
  <img src="files\var2\nftables br0rtr.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\hosts.png" width="600" />
</p>
...
>scp -P 2012 root@172.16.30.2:/etc/pki/CA/certs/web.au-team.irpo.crt /etc/nginx/ssl/

>scp -P 2012 root@172.16.30.2:/etc/pki/CA/private/web.au-team.irpo.key /etc/nginx/ssl/

>scp -P 2012 root@172.16.30.2:/etc/pki/CA/certs/docker.au-team.irpo.crt /etc/nginx/ssl/

>scp -P 2012 root@172.16.30.2:/etc/pki/CA/private/docker.au-team.irpo.key /etc/nginx/ssl/

<p align="center">
  <img src="files\var2\ssl.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\ipsec hq.png" width="600" />
</p>

Далее нужно настроить файл ipsec.secrets. Вносим туда строку:

***172.16.30.2 172.16.40.2 : PSK “123qweR%”***

<p align="center">
  <img src="files\var2\ipsec secret hq.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var2\ipsec br.png" width="600" />
</p>

Далее нужно настроить файл ipsec.secrets. Вносим туда строку:

***172.16.40.2 172.16.30.2 : PSK “123qweR%”***

<p align="center">
  <img src="files\var2\ipsec secret br.png" width="600" />
</p>
...
***curl -o /etc/nftables.conf https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/var2/nftables_hq-rtr.conf***
...
***curl -o /etc/nftables.conf https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/var2/nftables_br-rtr.conf***
