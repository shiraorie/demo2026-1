...
isp - ssh root@172.16.50.1
hq-srv - ssh sshuser@192.168.100.2 -p 2013
br-srv - ssh sshuser@192.168.200.2 -p 2013
...
<p align="center">
  <img src="files\var3\vlan hq-srv.png" width="600" />
</p>

<p align="center">
  <img src="files\var3\vlan hq-cli.png" width="600" />
</p>

<p align="center">
  <img src="files\var3\vlan hq-srv1.png" width="600" />
</p>

<p align="center">
  <img src="files\var3\vlan hq-cli1.png" width="600" />
</p>

**ISP преднастроена, но включать ее надо**

<p align="center">
  <img src="files\var3\table address.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\int hq-rtr.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\int br-rtr.png" width="600" />
</p>
...
- Идентификатор пользователя 2013
- Пользователь sshuser должен иметь возможность запускать sudo без дополнительной аутентификации

<p align="center"><b>*HQ-SRV и BR-SRV*</b></p>

<p align="center">
  <img src="files\var3\sshuser.png" width="600" />
</p>
...
- Для подключения используйте порт 2013 
...
<p align="center">
  <img src="files\var3\ssh.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\dns.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\samba-tool.png" width="600" />
</p>
...
- Имя устройства – md3, при необходимости конфигурация массива размещается в файле /etc/mdadm.conf
...
<p align="center">
  <img src="files\var3\lsblk.png" width="600" />
</p>
...
/dev/md3 — устройство RAID, которое появится после сборки;
-l 5 — уровень RAID;
...
<p align="center">
  <img src="files\var3\mdadm create.png" width="600" />
</p>

Проверяем:

<p align="center">
  <img src="files\var3\lsblk raid.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\mdadm detail.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\mkfs.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\mkdir raid5.png" width="600" />
</p>

<p align="center">
  <img src="files\var3\fstab.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\mount av.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\df -h raid.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\exports.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\exportfs.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\fstab cli.png" width="600" />
</p>
...
- На ISP настройте сервер chrony, выберите стратум 8
...
<p align="center">
  <img src="files\var3\chrony.png" width="600" />
</p>
...
> - local stratum 8 - устанавливаем для себя значение по stratum = 8;  
...
<p align="center">
  <img src="files\var3\chrony cli.png" width="600" />
</p>

> где: 172.16.50.1 - IPv4 адрес ISP;
...
***curl -o /etc/ansible/hosts https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/var3/hosts.file***
...
<p align="center">
  <img src="files\var3\ssh copy id.png" width="600" />
</p>
...
- Пробросьте порт 2013 на маршрутизаторе HQ-RTR в порт 2013 сервера HQ-SRV, для подключения к серверу по протоколу ssh из внешних сетей
- Пробросьте порт 2013 на маршрутизаторе BR-RTR в порт 2013 сервера BR-SRV, для подключения к серверу по протоколу ssh из внешних сетей.
...
<p align="center">
  <img src="files\var3\hosts.png" width="600" />
</p>
...
>scp -P 2013 root@172.16.50.2:/etc/pki/CA/certs/web.au-team.irpo.crt /etc/nginx/ssl/

>scp -P 2013 root@172.16.50.2:/etc/pki/CA/private/web.au-team.irpo.key /etc/nginx/ssl/

>scp -P 2013 root@172.16.50.2:/etc/pki/CA/certs/docker.au-team.irpo.crt /etc/nginx/ssl/

>scp -P 2013 root@172.16.50.2:/etc/pki/CA/private/docker.au-team.irpo.key /etc/nginx/ssl/
...
<p align="center">
  <img src="files\var3\ippsec hq.png" width="600" />
</p>

Далее нужно настроить файл ipsec.secrets. Вносим туда строку:

***172.16.50.2 172.16.60.2 : PSK “123qweR%”***

<p align="center">
  <img src="files\var3\ipsec secret hq.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var3\ipsec br.png" width="600" />
</p>

Далее нужно настроить файл ipsec.secrets. Вносим туда строку:

***172.16.60.2 172.16.50.2 : PSK “123qweR%”***

<p align="center">
  <img src="files\var3\ipsec secret br.png" width="600" />
</p>
...
***curl -o /etc/nftables.conf https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/var3/nftables_hq-rtr.conf***
...
***curl -o /etc/nftables.conf https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/var3/nftables_br-rtr.conf***
