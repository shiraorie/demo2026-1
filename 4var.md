...
isp - ssh root@172.16.70.1
hq-srv - ssh sshuser@192.168.100.2 -p 2014
br-srv - ssh sshuser@192.168.200.2 -p 2014
...
<p align="center">
  <img src="files\var4\vlan hq-srv.png" width="600" />
</p>

<p align="center">
  <img src="files\var4\vlan hq-cli.png" width="600" />
</p>

<p align="center">
  <img src="files\var4\vlan hq-srv1.png" width="600" />
</p>

<p align="center">
  <img src="files\var4\vlan hq-cli1.png" width="600" />
</p>

**ISP преднастроена, но включать ее надо**

<p align="center">
  <img src="files\var4\address table.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\int hq-rtr.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\int br-rtr.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\sshuser.png" width="600" />
</p>
...
- Для подключения используйте порт 2014 
...
<p align="center">
  <img src="files\var4\ssh.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\dns.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\samba-tool.png" width="600" />
</p>
...
Создаем пять юзеров(формата: hquser1, hquser2):

<p align="center">
  <img src="files\var1\spisok user.png" width="600" />
</p>

<p align="center">
  <img src="files\var1\create user.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var1\user group.png" width="600" />
</p>
...
- При помощи трех подключенных к серверу дополнительных дисков размером 1 Гб сконфигурируйте дисковый массив уровня 5
- Имя устройства – md4, при необходимости конфигурация массива размещается в файле /etc/mdadm.conf
...
<p align="center">
  <img src="files\var4\lsblk.png" width="600" />
</p>

Создайте RAID 5 массив из двух 1Гб дисков (предположим, они определены как /dev/sdb, /dev/sdc, /dev/sdd:
...
/dev/md4 — устройство RAID, которое появится после сборки;
-l 5 — уровень RAID;
-n 3 — количество дисков, из которых собирается массив;
/dev/sd{b,c} — сборка выполняется из дисков sdb, sdc и sdd.

> mdadm --create --verbose /dev/md4 -l 5 -n 3 /dev/sdb /dev/sdc /dev/sdd

Результат:

<p align="center">
  <img src="files\var4\mdadm create.png" width="600" />
</p>

Проверяем:

<p align="center">
  <img src="files\var4\lsblk mdadm.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\mdadm detail.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\mkfs.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\mkdir raid5.png" width="600" />
</p>

<p align="center">
  <img src="files\var4\fstab raid.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\mount -av.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\df -h.png" width="600" />
</p>

### <p align="center"><b>3. Настройте сервер сетевой файловой системы (nfs) на HQ-SRV</b></p>

- В качестве папки общего доступа выберите /raid5/nfs, доступ для чтения и записи исключительно для сети в сторону HQ-CLI
...
Создаём директорию для общего доступа /raid5/nfs, куда ранее был смонтирован RAID - массив:
...
192.168.10.0/28 - клиентская сеть, которой разрешено монтирования общего ресурса
rw — разрешены чтение и запись
no_root_squash — отключение ограничения прав root

<p align="center">
  <img src="files\var4\exports.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\exportfs.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\fstab cli.png" width="600" />
</p>
...
- На ISP настройте сервер chrony, выберите стратум 9
...
<p align="center">
  <img src="files\var4\chrony.png" width="600" />
</p>
...
> - local stratum 9 - устанавливаем для себя значение по stratum = 9;  
...
<p align="center">
  <img src="files\var4\chrony cli.png" width="600" />
</p>

> где: 172.16.70.1 - IPv4 адрес ISP;
...
***curl -o /etc/ansible/hosts https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/var4/hosts.file***
...
<p align="center">
  <img src="files\var4\ssh copy id.png" width="600" />
</p>
...
- Пробросьте порт 2014 на маршрутизаторе HQ-RTR в порт 2014 сервера HQ-SRV, для подключения к серверу по протоколу ssh из внешних сетей
- Пробросьте порт 2014 на маршрутизаторе BR-RTR в порт 2014 сервера BR-SRV, для подключения к серверу по протоколу ssh из внешних сетей.
...
<p align="center">
  <img src="files\var4\hosts.png" width="600" />
</p>
...
>scp -P 2014 root@172.16.70.2:/etc/pki/CA/certs/web.au-team.irpo.crt /etc/nginx/ssl/

>scp -P 2014 root@172.16.70.2:/etc/pki/CA/private/web.au-team.irpo.key /etc/nginx/ssl/

>scp -P 2014 root@172.16.70.2:/etc/pki/CA/certs/docker.au-team.irpo.crt /etc/nginx/ssl/

>scp -P 2014 root@172.16.70.2:/etc/pki/CA/private/docker.au-team.irpo.key /etc/nginx/ssl/

<p align="center">
  <img src="files\var3\ssl.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\ipsec hq.png" width="600" />
</p>

Далее нужно настроить файл ipsec.secrets. Вносим туда строку:

***172.16.70.2 172.16.80.2 : PSK “123qweR%”***

<p align="center">
  <img src="files\var4\ipsec secret hq.png" width="600" />
</p>
...
<p align="center">
  <img src="files\var4\ipsec br.png" width="600" />
</p>

Далее нужно настроить файл ipsec.secrets. Вносим туда строку:

***172.16.80.2 172.16.70.2 : PSK “123qweR%”***

<p align="center">
  <img src="files\var4\ipsec secret br.png" width="600" />
</p>
...
***curl -o /etc/nftables.conf https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/var4/nftables_hq-rtr.conf***
...
***curl -o /etc/nftables.conf https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/var4/nftables_br-rtr.conf***
...
*** curl -o /etc/zabbix/zabbix.conf.php https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/zabbix.conf.php***
...
<p align="center">
  <img src="images/module3/HOSTNAME.png" width="600" />
</p>

<p align="center">
  <img src="images/module3/SERVER.png" width="600" />
</p>
...
<p align="center">
  <img src="images/module3/HOST.png" width="600" />
</p>
